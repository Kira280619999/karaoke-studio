...
- Output mặc định CFR 1920×1080/60fps, H.264 `yuv420p`, AAC 48 kHz/320 kbps và `faststart` để tương thích rộng; vẫn có preset 1080p120, 1080p30 hoặc theo nguồn. Preset 120fps dùng clock 120 kHz, không có B-frame đảo timestamp và được QA từng packet để tăng tương thích với player HFR; thiết bị vẫn cần hỗ trợ giải mã H.264 1080p120. Tên file gắn revision timeline và download dùng `no-store` để tránh mở nhầm bản cache cũ.
