...
- Khung Preview lấy mẫu trên lưới 1920×1080/120fps để timecode, bước từng frame, chuyển động nền và quét chữ vẫn chính xác đến 1/120 giây; bản xuất 60fps tương thích lấy đúng các mốc khung tương ứng. Video nguồn 30/60fps vẫn được giữ nguyên để nghe/căn timing; số khung thực sự nhìn thấy phụ thuộc tần số quét màn hình. Preview chỉ phát video và hai dòng Karaoke, không có vùng bấm theo từ, tay nắm timing hoặc toolbar nổi che hình. Mọi chỉnh sửa được tập trung duy nhất ở `Cuộn timeline toàn bài`; khối Timing Editor trùng chức năng đã được loại bỏ.
...
- Output mặc định CFR 1920×1080/60fps, H.264 `yuv420p`, AAC 48 kHz/320 kbps và `faststart` để tương thích rộng; vẫn có preset 1080p120, 1080p30 hoặc theo nguồn. Preset 120fps cần player hỗ trợ, nhiều thời gian render và dung lượng hơn; độ mượt Preview trực tiếp còn phụ thuộc tần số quét màn hình.
